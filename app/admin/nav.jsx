const Nav = () => {
    return ( 
        ...
        <a className="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="/index.html">
        <span className="icon"><img className="center-block" src="img/Punppy 1.png" height="69" alt="Punppy"/></span></a>
