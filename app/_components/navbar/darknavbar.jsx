...
const Navbar = () => {
    return ( 
        <div>
            <nav className="navbar navbar-transparent navbar-expand-lg navbar-light px-lg-5 py-lg-5">
        <div className="container-fluid">
          <a className="navbar-brand" href="/"><img src="images/logo/logo.png" width="100"/></a>
